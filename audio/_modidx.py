...
d = { 'settings': { 'branch': '{branch}',
  ...
  'syms': { 'audio.audio': { 'audio.audio.AudioSlicer': ('audio.html#audioslicer', 'audio/audio.py'),
                             ...
                             'audio.audio.AudioSlicer.append_raw_audio': ('audio.html#audioslicer.append_raw_audio', 'audio/audio.py'),
            ...
            'audio.diarize_transcribe': { 'audio.diarize_transcribe.Notification': ( 'audio_processor_from_file.html#notification',
                                          ...
                                          'audio.diarize_transcribe.transcribe': ( 'audio_processor_from_file.html#transcribe',
                                                                                   'audio/diarize_transcribe.py')},
            'audio.process': { 'audio.process.Notification': ('audio_processor_from_file.html#notification', 'audio/process.py'),
                               'audio.process.Notification.initialize': ( 'audio_processor_from_file.html#notification.initialize',
                                                                          'audio/process.py'),
                               'audio.process.Notification.wait': ('audio_processor_from_file.html#notification.wait', 'audio/process.py'),
                               'audio.process.diarize': ('audio_processor_from_file.html#diarize', 'audio/process.py'),
            ...
            'audio.redis': { 'audio.redis.ApiConnection': ('redis.html#apiconnection', 'audio/redis.py'),
                             ...
                             'audio.redis.Audio.fix': ('redis.html#audio.fix', 'audio/redis.py'),
                             ...
                             'audio.redis.get_connection_queues': ('redis.html#get_connection_queues', 'audio/redis.py'),
