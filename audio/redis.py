...
# %% auto 0
__all__ = ['get_redis', 'get_inner_redis', 'log', 'get_connections_df', 'get_connections', 'StreamItem', 'ApiConnection',
...
class Audio(Data):
    def __init__(self, chunk_name: str, redis_client: redis.client.Redis, data: bytes = None):
        super().__init__(chunk_name=f'Audio:{chunk_name}', key='audio', redis_client=redis_client, data=data)
...
class Transcript(Data):
    def __init__(self, chunk_name: str, redis_client: redis.client.Redis, data: List = None):
        super().__init__(chunk_name=f'Transcript:{chunk_name}', key='transcription', redis_client=redis_client, data=data)

class Diarisation(Data):
    def __init__(self, chunk_name: str, redis_client: redis.client.Redis, data: List = None):
        super().__init__(chunk_name=f'Diarisation:{chunk_name}', key='diarisation', redis_client=redis_client, data=data)
