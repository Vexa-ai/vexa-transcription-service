...
# %% auto 0
__all__ = ['redis_inner_client', 'client_id', 'diarize_ready_notification', 'transcribe_ready_notification', 'Notification',
           'diarize', 'transcribe', 'get_next_chunk_start']
...
asyncio.run(diarize_ready_notification.initialize())
transcribe_ready_notification = Notification('TranscribeReady',redis_inner_client)
asyncio.run(transcribe_ready_notification.initialize())
...
# %% ../nbs/03_audio_processor_from_file.ipynb 8
...
# %% ../nbs/03_audio_processor_from_file.ipynb 9
...
# %% ../nbs/03_audio_processor_from_file.ipynb 12
async def get_next_chunk_start(diarization_result, length):
    if len(diarization_result)>0:
        last_speech = diarization_result[-1]
