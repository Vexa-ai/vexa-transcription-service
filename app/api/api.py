...
from app.api.server_token import ServerToken
...
# v1 API endpoints
router.include_router(embeddings_router, prefix="/v1", dependencies=[Depends(ServerToken())])
router.include_router(health_router, prefix="/v1")
router.include_router(segments_router, prefix="/v1", dependencies=[Depends(ServerToken())])
